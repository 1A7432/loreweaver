...
`rules`, `rooms`, `cast`, `world`, `panels`, `media`, `llm`, `forge`). Import the public
names from here; monkeypatch a helper where it is DEFINED (e.g. `gateway.commands.llm.flow_for`).
"""
