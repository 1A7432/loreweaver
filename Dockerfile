...
# `python -m app` is the program; the default CMD runs the WS server on all
# interfaces. Override the ARGS (everything after the image name) to run other
# subcommands, e.g. mint a key:
